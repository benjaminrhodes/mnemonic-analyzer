"""BIP-39 wordlists for multiple languages."""

# English BIP-39 wordlist (first 100 for reference - full list has 2048 words)
...
ENGLISH_WORDLIST = [
    ...
    "escape", "essence", "estate", "eternal", "ethics", "evidence", "evil", "evoke",
    ...
    "girl", "give", "glad", "glance", "glare", "glass", "gleam", "glide",
    ...
    "reproduce", "public", "request", "rescue", "resemble", "resist", "resource", "response",
    ...
    "rookie", "room", "root", "rose", "rotate", "rough", "round", "route",
    ...
    "scent", "school", "science", "scissors", "scorpion", "scout", "scrap", "screen",
...
# Additional language wordlists can be added here:
# SPANISH_WORDLIST, FRENCH_WORDLIST, ITALIAN_WORDLIST, etc.

def get_wordlist(language: str = "en") -> list[str]:
    """Get BIP-39 wordlist by language code.
    
    Args:
        language: Two-letter language code (en, es, fr, it, ja, ko, pt, zh)
    
    Returns:
        List of 2048 words for the specified language
    ...
    wordlists = {
        "en": ENGLISH_WORDLIST,
        # Add additional languages as they're added
    }
    
    if language not in wordlists:
        raise ValueError(f"Unsupported language: {language}. Supported: {list(wordlists.keys())}")
    
    return wordlists[language]


def get_wordlist_set(language: str = "en") -> set[str]:
    """Get BIP-39 wordlist as a set for fast lookup.
    
    Args:
        language: Two-letter language code
    
    Returns:
        Set of words for O(1) lookup
    """
    return set(get_wordlist(language))
